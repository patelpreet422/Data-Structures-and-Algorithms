...
template <typename T> using Graph = unordered_map<T, vector<T>>;

template <typename T> void bfs(Graph<T> graph, T vertex) {
...
template <typename T> void dfs(Graph<T> graph, T vertex) {
