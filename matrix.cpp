...
struct matrix{
    ...
    matrix(const matrix<T>& m) { this->data = m.data; cout << "copy_ctor\n"; }
    matrix(matrix<T>&& m) { this->data = std::move(m.data); cout << "move_ctor\n"; }

    void operator=(const matrix<T>& m) { this->data = m.data; cout << "copy_assign\n"; }
    void operator=(matrix<T>&& m) { this->data = std::move(m.data); cout << "move_assign\n"; }

    vector<vector<T>> data;

    pair<size_t, size_t> shape() const { return make_pair(this->row(), this->column()); }
